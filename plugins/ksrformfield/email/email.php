...
class plgKsrformfieldEmail extends JPlugin 
{
	...
	public function onDisplayFieldView($field_params)
	{
		...
		$field_params->params['system-email'] = isset($field_params->params['system-email']) ? $field_params->params['system-email'] : 0;
	...
	{
		JForm::addFormPath(JPATH_ROOT . '/plugins/ksrformfield/email/assets/forms');

		$form = JForm::getInstance('ksrformfield.email.'.$name, $name, array(
			'control' => '',
			'load_data' => true
		));
