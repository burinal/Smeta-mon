...
class plgKsrformfieldPhone extends JPlugin 
{
	...
	public function __construct(& $subject, $config)
	{
		...
		JHtml::_('script', JUri::root() . 'plugins/ksrformfield/phone/assets/js/jquery.maskedinput.js', false, true, false, false, true);
	}	
	...
	public function onDisplayFieldView($field_params)
	{
		...
		$field_params->params['system-phone'] = isset($field_params->params['system-phone']) ? $field_params->params['system-phone'] : 0;
	...
	{
		JForm::addFormPath(JPATH_ROOT . '/plugins/ksrformfield/phone/assets/forms');

		$form = JForm::getInstance('ksrformfield.phone.'.$name, $name, array(
			'control' => '',
			'load_data' => true
		));
