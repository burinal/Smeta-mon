...
if($view_mode == 0){?>
    <div class="measurement_sign_up">
                <span onclick="openForm()" data-popup="order_master">Записаться на замер</span>
            </div>
<?php }
...
if(($view_mode == 0) || ($view_mode == 2)){ ?>
    ...
    <div class="window call_master form-action-sc">
        <span class="close" data-popup="close"></span>
        <div class="title">Вызвать мастера на замер</div>
        <form action="javascript:void(0)">
            <input type="text" value="Введите ваше имя..." class="placeholder_color" data-value="Введите ваше имя...">
            <input type="text" value="Введите ваш телефон..." class="placeholder_color" data-value="Введите ваш телефон...">
            <textarea cols="5" rows="5" class="placeholder_color" data-value="Укажите адрес, удобное время, код домовона и дополнительные пожелания.">Укажите адрес, удобное время, код домовона и дополнительные пожелания.</textarea>
