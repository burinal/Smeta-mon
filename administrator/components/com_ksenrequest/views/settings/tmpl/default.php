...
<div class="clearfix panel">
    <div class="pull-left">
        <?php echo KSSystem::loadModules('ksp-top-left'); ?>
    </div>
    <div class="pull-right">
        <?php echo KSSystem::loadModules('ks-top-right'); ?>
    </div>
    <div class="row-fluid">
        <?php echo KSSystem::loadModules('ksp-top-bottom'); ?>
    </div>
</div>
<div id="center">
	<table id="cat" width="100%">
		<tr>
			<td width="250" class="left-column">
				<div id="tree">
					<ul>
						<?php echo KSSystem::loadModules('ksp-list-left'); ?>
					</ul>	
				</div>
			</td>
			<td valign="top">
				<form action="<?php echo JRoute::_('index.php?option=com_ksenportfolio');?>" id="settings-form" method="post" class="form" name="adminForm" autocomplete="off" class="form-validate">
