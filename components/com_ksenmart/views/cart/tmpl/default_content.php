    ...
    <div class="ksm-cart-items">
        <div class="ksm-cart-items-head">
            <div class="ksm-cart-item-left">
                ...
                <div class="ksm-cart-item-art">Артикул</div>
    ...
    <div class="ksm-cart-items-total">
        <?php if (isset($this->cart->discount_sum) && $this->cart->discount_sum > 0): ?>
            <div class="ksm-cart-items-total-block ksm-cart-items-total-discount">
                <?php echo JText::_('KSM_CART_DISCOUNT_SUM_TEXT'); ?> <span
                        class="ksm-cart-items-total-discount-price"><?php echo $this->cart->discount_sum_val; ?></span>
            </div>
        <?php endif; ?>
        <div class="ksm-cart-items-total-block ksm-cart-items-total-sum">
            <?php echo JText::_('KSM_CART_ITEMS_TOTAL_SUM_TEXT'); ?> <span
                    class="ksm-cart-items-total-sum-price"><?php echo KSMPrice::showPriceWithTransform($this->cart->products_sum - $this->cart->discount_sum); ?></span>
        </div>
    </div>
    <button class="ksm-btn-success" id="ksm-cart-show-order"><span
                class="uline"><?php echo JText::_('KSM_CART_CHECKOUT_TEXT'); ?></span></button>
</div>